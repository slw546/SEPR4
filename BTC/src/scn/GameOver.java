...
public class GameOver extends Scene {
	 ...
	 */
	public GameOver(Main main, Aircraft aircraft1, Aircraft aircraft2, int score) {
		super(main);
		...
		Vector midPoint = crashedAircraft1.position()
				.add(crashedAircraft2.position()).scaleBy(0.5);
		...
		explosionAnim = new SpriteAnimation(explosion, (int)explosionPos.x(),
				(int)explosionPos.y(), 6, 16, framesAcross, framesDown, false, false);
	}
