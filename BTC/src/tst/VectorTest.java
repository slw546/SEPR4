...
public class VectorTest {		
	...
	public void testNormalise() {
		...
		assertTrue("Normalise = 1/3, 2/3, 2/3", 
				((1d / 3d) == (resultVector.x()))
				&& ((2d / 3d) == (resultVector.y()))
				&& ((2d / 3d) == (resultVector.z())));	
	...
	public void testNormalise2() {
		...
		assertTrue("Normalise = 1/9, 4/9, 8/9", 
				((1d / 9d) == (resultVector.x()))
				&& ((4d / 9d) == (resultVector.y()))
				&& ((8d / 9d) == (resultVector.z())));	
	}
